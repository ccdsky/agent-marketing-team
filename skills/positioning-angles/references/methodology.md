# Positioning Angles — Extended Reference
...
- If a competitor could use this exact name, it's not specific enough.
...
- If yes → strong candidate for category creation. Flag for Category Creation angle.
...
- **Mechanism-based:** "The only [product type] that works by [unique mechanism]" — Reference mechanism output
...
- **Category creation:** "[Product] is the first [new category name] for [ICP]" — Prerequisite: mechanism passes Thiel's "secret" test. The mechanism defines the category — the category name should make the mechanism's insight self-evident.

---

## Scoring Dimensions — Full Guide

| Dimension | What it measures | Score 5 | Score 3 | Score 1 |
|-----------|------------------|---------|---------|---------|
| **Defensibility** | Can competitors copy in 6 months? | Structural/IP advantage | Partially replicable | Easily copied |
| **ICP Resonance** | Does the target ICP actually care? | Directly addresses primary pain | Addresses secondary pain | Tangential |
| **Provability** | Can we demonstrate with evidence? | Specific data/case studies | Some supporting evidence | Claim only |

**Evidence tagging (required):**
- **[E]** Evidence-based — score directly supported by research package data
- **[I]** Inferred — score based on ICP profile interpretation without specific evidence

Scores with [I] tags are hypotheses, not facts. Flag for validation.

---

## Laja's 4-Layer Test — Applied to Top Angles
...
## Sprint 1 Checkpoint Protocol

Do not proceed to Sprint 2 asset creation. This output presents options — the human selects direction.

When handing off to Campaign Lead, include:
- Top-scoring recommendation and why it leads
- The 2-3 alternative angles and trade-offs each represents
...
[Continue for all qualifying angles, score descending]
